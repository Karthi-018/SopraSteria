...
public class Test3{
    public static void main(String[] args) {
      ...
      String options[][] ={{"1.Albert Einstein","2.Nikola Tesla" , "3.Charles Darwin" ,"4.James Gosling"},
      ...
      while(num<questions.length){
          ...
          if(ch1==1){
              ...
              System.out.println("The Answer you have given is: "+ options[num-1][choices[num-1]-1]);
              result[num-1]=0;
              choices[num-1]=0;
              num--;
          }

  ...
  <tbody>
    <tr>
      <td><%=request.getAttribute("pid")==null?"-":request.getAttribute("pid") %></td>
         ...
         <td><form action="Delete"><button name = "pid"  class='btn btn-primary' value = "<%=request.getAttribute("pid")%>">Delete</button>
         </form><br><form action="Search2"><button name = "pid" class='btn btn-primary'  value = "<%=request.getAttribute("pid")%>">Edit</button></form></td>
    </tr>
  </tbody>
</table>
 </center>

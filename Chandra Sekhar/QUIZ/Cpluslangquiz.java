...
public class Cpluslangquiz {

    Scanner scan = new Scanner(System.in);
    int marks = 0;
    public Cpluslangquiz(int a1) {
    ...
    public Cpluslangquiz(int a1, int a2) {
        this(a1);
    ...
    public Cpluslangquiz(int a1, int a2, int a3) {
        this(a1, a2);
    ...
    public Cpluslangquiz(int a1, int a2, int a3, int a4) {
        this(a1, a2, a3);
    ...
    public Cpluslangquiz(int a1, int a2, int a3, int a4, int a5) {
        this(a1, a2, a3, a4);

...
public class Javalangquiz {

    Scanner scan = new Scanner(System.in);
    int marks = 0;
    public Javalangquiz(int a1) {
    ...
    public Javalangquiz(int a1, int a2) {
        this(a1);
    ...
    public Javalangquiz(int a1, int a2, int a3) {
        this(a1, a2);
    ...
    public Javalangquiz(int a1, int a2, int a3, int a4) {
        this(a1, a2, a3);
    ...
    public Javalangquiz(int a1, int a2, int a3, int a4, int a5) {
        this(a1, a2, a3, a4);

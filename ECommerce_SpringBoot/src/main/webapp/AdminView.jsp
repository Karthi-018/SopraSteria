...
<td><%=p.getPrice() %></td>
<td><%=p.getQuantity() %></td>
<td><form action='DeleteProduct' ><button name= 'delete' value="<%=p.getpId()%>">DELETE</button></form>
<form action='EditProduct' ><button name='edit' value="<%= p.getpId() %>">EDIT</button></form></td>
</tr>
<%} %>
</tbody>
</table>

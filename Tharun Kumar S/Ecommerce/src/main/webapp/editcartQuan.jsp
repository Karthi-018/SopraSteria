...
<label>Product Quantity</label><br><input type = "number" name = "quan" value="<%=p1.getQuant()%>" required min='1' max='<%=(int)p.getQuan()%>'><br><br>
<input type = "submit" name="method" value ="Edit Quantity">
<br>
</form>

...
/**
 * Servlet implementation class Csearch
 */
@WebServlet("/Csearch")
public class Csearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd= request.getRequestDispatcher("Csearch.jsp");
		try{
		Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            ResultSet resultSet=statement.executeQuery("select * from Eprods where pname ='"+pname+"'");

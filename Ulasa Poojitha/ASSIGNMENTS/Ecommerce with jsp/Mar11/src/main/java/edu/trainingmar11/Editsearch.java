...
/**
 * Servlet implementation class Editsearch
 */
@WebServlet("/Editsearch")
public class Editsearch extends HttpServlet {
...
//		RequestDispatcher rd= request.getRequestDispatcher("Searchedit.jsp");
		try{
			Class.forName("com.mysql.cj.jdbc.Driver");
	            ...
	            ResultSet resultSet=statement.executeQuery("select * from Eprods where pid ='"+gid+"'");

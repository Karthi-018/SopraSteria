...
public class Wish extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
            ...
            ResultSet resultSet=statement.executeQuery("select p.pid, p.pname,p.pdesc,p.pprice  from wishlist as c INNER JOIN Eprods as p where c.pid=p.pid and gname ='"+name+"'");         
